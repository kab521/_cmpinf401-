...
public class RecordList {
	...
	public int indexOf(String name) {
		...
		//linked list - basically make it so the new list item knows where to go in order
	...
	// same thing above w the linked list, using the data
...
file.delete();
		...
		try {
			...
			//closing both the file writer and the buffered writer
			fw.close();
			bw.close();
			
		} catch (Exception e) {
			
			System.out.println("Your race results are above!");
