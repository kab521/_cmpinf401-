...
outputwindow.setBounds(300, 200, 600, 500);
...
allmenus.setBounds(10, 20, outputwindow.getWidth()/2-40, outputwindow.getHeight()-300);
...
this.allthestuff.setBounds(medscreen.getWidth() + 10, 
medscreen.getY(), outputwindow.getWidth()/1-10, outputwindow.getHeight()-10);
